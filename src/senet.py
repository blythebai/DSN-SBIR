...
class CSENet_hashing(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.2,
        ...
        # layer0_modules.append(('pool', nn.MaxPool2d(3, stride=None, padding=0, 
    ...
    def features(self, x, y):
        # todo: check
        # print("zjj1 x.shape = ", x.shape)
        x = self.layer0(x)
        # print("zjj x.shape = ", x.shape)
        for m in self.layer1._modules.values():
            x = m(x, y)
...
def initialize_pretrained_model_ext(model, num_classes, settings):
    ...
    # print("testest777777777777")
    # pretrained_state_dict = torch.load("/home/baiyh/DSN-ZS-SBIR/DSNbaseline/cse_resnet50/se_resnet50-ce0d4300.pth")
    pretrained_state_dict = torch.load("../cse_resnet50/se_resnet50-ce0d4300.pth")
    # print("zjj enter in pretrained_state_dict!!!!")
